...
const BlastIcon = (props: { className?: string }) => (
  <svg
    className={props.className}
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
...
const icons = {
  ...
  [NETWORK.blast]: { svgIcon: BlastIcon, iconBgColor: '#0052FF' }
}
